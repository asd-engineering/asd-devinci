...
# Export basic auth credentials for Caddy tunnel route protection
echo "ASD_BASIC_AUTH_USERNAME=${SESSION_USERNAME}" >> "$GITHUB_ENV"
echo "ASD_BASIC_AUTH_PASSWORD=${SESSION_PASSWORD}" >> "$GITHUB_ENV"
...
export ASD_BASIC_AUTH_USERNAME="${SESSION_USERNAME}"
export ASD_BASIC_AUTH_PASSWORD="${SESSION_PASSWORD}"
...
ASD_BASIC_AUTH_USERNAME=${SESSION_USERNAME}
ASD_BASIC_AUTH_PASSWORD=${SESSION_PASSWORD}
EOF
chmod 600 .env
